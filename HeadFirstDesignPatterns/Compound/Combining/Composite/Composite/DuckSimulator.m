...
- (void)simulate: (id<DuckFactory>)duckFactory {
	...
	NSLog(@"Duck Simulator: With Composite - Flocks");
    ...
    NSLog(@"Duck Simulator: Whole Flock Simulation");
	[self simulateWithDuck: flockOfDucks];
    
    NSLog(@"Duck Simulator: Mallard Flock Simulation");
	[self simulateWithDuck: flockOfMallards];
